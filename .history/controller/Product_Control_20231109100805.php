    ...
    class Product_Control{
       ...
       // echo '<script>window.location="./?select=product-categories";</script>';
        ...
        public function add_new_product(){
            ...
            require_once '../module/Product.php';
            $temp = new Product(); $temp->add_new_product_todatabase($phanloai, $title,$pathav,$giaban,$tinhtrang,$soluong,$posts,$thuonghieu,$xuatxu,$trongluong,$phuukien);
        ...
        public function edit_a_product(){
            ...
            if($_FILES['imgInp']['error'] == 0)
            {
              ...
              $temp->edit_a_product_todatabase($id, $phanloai, $title,$giaban,$tinhtrang,$soluong,$posts,$thuonghieu,$xuatxu,$trongluong,$phuukien);
