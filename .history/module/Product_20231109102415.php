...
class Product
{
    ...
    public function add_new_product_todatabase($phanloai, $ten,$img,$giaban,$tinhtrang,$soluong,$posts,$thuonghieu,$xuatxu,$trongluong,$phukien){
        if(!$this->getconect){
            return 0;
        }else{
            $sql = "INSERT INTO sanpham value (null,$phanloai,'$ten','$img',$giaban,'$tinhtrang',$soluong,$posts,'$thuonghieu','$xuatxu','$trongluong','$phukien')";
            mysqli_query($this->getconect, $sql);
            return true;
        }
        return 0;
    ...
    public function edit_a_product_todatabase($id, $phanloai, $ten,$giaban,$tinhtrang,$soluong,$posts,$thuonghieu,$xuatxu,$trongluong, $phukien){
        if(!$this->getconect){
            return 0;
        }else{
            $sql = "UPDATE sanpham set id_phanloai = $phanloai,ten = '$ten', giaban = $giaban,tinhtrang = '$tinhtrang',soluong = $soluong,posts='$posts',thuonghieu ='$thuonghieu',xuatxu='$xuatxu',trongluong='$trongluong',phukien='$phukien' where id = $id";
            mysqli_query($this->getconect, $sql);
            return true;
        }
        return 0;
